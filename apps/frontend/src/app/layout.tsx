...
export const metadata: Metadata = {
  ...
  description:
    'Nopea, turvallinen ja läpinäkyvä muutto Helsingissä ja Uudellamaalla. Koti- ja yritysmuutot, pakkaus, kuljetukset ja kuolinpesätyhjennnykset. Pyydä maksuton tarjous!',
  keywords: [
    'muutto',
    'muuttofirma',
    'muuttopalvelu',
