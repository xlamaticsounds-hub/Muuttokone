  ...
  return (
    <>
      <div className="mx-auto mt-12.5 max-w-1390 px-4 md:px-8 2xl:px-0">
        <div className="projects-tab shadow-3 dark:bg-blacksection mx-auto mb-17.5 flex max-w-fit flex-wrap items-center justify-center gap-5 rounded-full bg-white px-2.5 py-2 dark:shadow-none">
          {tabs.map((tab, index) => (
            <button
              key={index}
